...
using DotNetDev.Mvc.IronPython.Controllers;

namespace DotNetDev.Mvc.IronPython.Web
{
	...
	public class MvcApplication : System.Web.HttpApplication
	{
		...
		protected void Application_Start()
		{
			...
			// Ensure we use IronPython controllers to satisfy requests
			ControllerBuilder.Current.SetControllerFactory(new IronPythonControllerFactory());
		}
	}
}